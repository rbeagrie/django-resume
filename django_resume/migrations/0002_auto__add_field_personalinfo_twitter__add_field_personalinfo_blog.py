...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PersonalInfo.twitter'
        db.add_column(u'django_resume_personalinfo', 'twitter',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'PersonalInfo.blog'
        db.add_column(u'django_resume_personalinfo', 'blog',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PersonalInfo.twitter'
        db.delete_column(u'django_resume_personalinfo', 'twitter')

        # Deleting field 'PersonalInfo.blog'
        db.delete_column(u'django_resume_personalinfo', 'blog')
