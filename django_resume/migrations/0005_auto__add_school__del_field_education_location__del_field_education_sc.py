...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'School'
        db.create_table(u'django_resume_school', (
            ...
            ('education', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['django_resume.Education'])),
        ))
        db.send_create_signal(u'django_resume', ['School'])

        # Deleting field 'Education.location'
        db.delete_column(u'django_resume_education', 'location')

        # Deleting field 'Education.school_url'
        db.delete_column(u'django_resume_education', 'school_url')


    def backwards(self, orm):
        # Deleting model 'School'
        db.delete_table(u'django_resume_school')

        # Adding field 'Education.location'
        db.add_column(u'django_resume_education', 'location',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=250),
                      keep_default=False)

        # Adding field 'Education.school_url'
        db.add_column(u'django_resume_education', 'school_url',
