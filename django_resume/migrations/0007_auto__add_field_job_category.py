...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('jobs', 'category',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['django_resume.JobCategory']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Job.category'
        db.delete_column('jobs', 'category_id')
