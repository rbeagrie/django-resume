...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PersonalInfo.twitter'
        db.alter_column(u'django_resume_personalinfo', 'twitter', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'PersonalInfo.twitter'
        db.alter_column(u'django_resume_personalinfo', 'twitter', self.gf('django.db.models.fields.URLField')(max_length=255))
