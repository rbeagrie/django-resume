...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'JobCategory.order'
        db.add_column(u'django_resume_jobcategory', 'order',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'JobCategory.order'
        db.delete_column(u'django_resume_jobcategory', 'order')
    ...
    models = {
        ...
        u'django_resume.jobcategory': {
            'Meta': {'ordering': "['order']", 'object_name': 'JobCategory'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '250'}),
